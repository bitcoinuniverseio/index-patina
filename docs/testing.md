...
| `test/commit-leaf-history.test.ts` | Commit leaf history: both encodings stay parseable, and both histories index and replay to identical artifact ids and per-block state roots. |
